                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-sm mb-3" id="table-web">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>NIP</th>
                                            ...
                                            <tbody>
                                                @php
                                                    $no = 1;
                                                @endphp
                                                @foreach ($instructor_web as $inst)
                                                    <tr>
                                                        <td>{{ $no++ }}. </td>
                                                        <td>{{ $inst->nip }}</td>
                                                        <td>{{ $inst->name }}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{ route('users.destroy', $inst->id) }}"
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        <div class="col mb-3">
                                                                            ...
                                                                            <select name="level" id="level"
                                                                                ...
                                                                                @foreach ($levels as $level)
                                                                                    <option
                                                                                        {{ $inst->level_id == $level->id ? 'selected' : '' }}
                                                                                        value="{{ $level->id }}">
                                                                                        {{ $level->name_levels }}
                                                                                    </option>
                                                                                @endforeach
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col mb-3">
                                                                                ...
                                                                                <textarea name="address" id="" cols="30" rows="5" class="form-control">{{ $inst->address }}</textarea>
                                                                            </div>
                                                                        </div>
